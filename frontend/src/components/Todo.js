...
function Todo() {
    ...
    useEffect(() => {
        axios.get('http://[2a09:8280:1::43:6bc7:0]/getTodoList')
            .then(result => {
    ...
    const addTask = (e) => {
        ...
        axios.post('http://[2a09:8280:1::43:6bc7:0]/addTodoList', { task: newTask, status: newStatus, deadline: newDeadline })
            .then(res => {
                console.log(res);
    ...
    const saveEditedTask = (id) => {
        ...
        axios.post('http://[2a09:8280:1::43:6bc7:0]/updateTodoList/' + id, editedData)
            .then(result => {
                console.log(result);
                setEditableId(null);
                setEditedTask("");
    ...
    const deleteTask = (id) => {
        axios.delete('http://[2a09:8280:1::43:6bc7:0]/deleteTodoList/' + id)
            .then(result => {
                console.log(result);
                window.location.reload();
            })
